...
#from mlab_base import parser
#from mlab_base import reader
#from mlab_base import texpand
#from mlab_base import metalist
#from mlab_base import createout
...
while 666 > 1:
    try: roda(date,'/Users/pedro/CTI/ID/MLab/NDT/',"l")
    except IOError:
